...
bool MainMenu::init()
{
	...
	auto itemOn = MenuItemImage::create("ui/button/ui_ocean_button_soundon.png", "ui/button/ui_blue_button_soundon.png", [&](Ref* sender) {
	...
	auto itemOff = MenuItemImage::create("ui/button/ui_ocean_button_soundoff.png", "ui/button/ui_blue_button_soundoff.png", [&](Ref* sender) {
